  ...
  End Function
	...
	public sub new()
      ...
      try
		...
		GetImageByUri("http://dnsi.googlecode.com/svn/apps/Regex.Net/Resources/lightoff.PNG",
			sub(image as image)
				m_lightoff = image
			End sub
		)

		GetImageByUri("http://dnsi.googlecode.com/svn/apps/Regex.Net/Resources/lightbroken.PNG",
			sub(image as image)
				m_lightbroken = image
			End sub
		)

		GetImageByUri("http://dnsi.googlecode.com/svn/apps/Regex.Net/Resources/lightbrokenb.PNG",
			sub(image as image)
